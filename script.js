...
const movieDatabase = {
    trending: [
        { id: 1, title: "Salaar", rating: 8.9, year: 2024, genre: "Action", language: "Telugu", image: "https://www.themoviedb.org/t/p/w1280/nlu9WbcetNFRGXXPWITr30ob7W6.jpg", coverImage: "https://media.themoviedb.org/t/p/w1066_and_h600_face/xtOCTmGemASooRkAxRorYODig1p.jpg", coverPosition: "center top", trailer: "https://youtu.be/4GPvYMKtrtI?si=rzopIuqu1QcQ-58Q" },
        { id: 2, title: "Devara", rating: 8.7, year: 2024, genre: "Action", language: "Telugu", image: "https://www.themoviedb.org/t/p/w1280/lQfuaXjANoTsdx5iS0gCXlK9D2L.jpg", coverImage: "https://media.themoviedb.org/t/p/w1066_and_h600_face/hAQnXxOwCjgYcKRgTdYPRC8neqL.jpg", coverPosition: "center top", trailer: "https://youtu.be/5cx7rvMvAWo?si=QTRpq5cw_S-nivad" },
        { id: 3, title: "HanuMan", rating: 8.5, year: 2024, genre: "Fantasy", language: "Telugu", image: "https://www.themoviedb.org/t/p/w1280/m1zq48rWSXxplzoJR8YtbXWnnHM.jpg", coverImage: "https://media.themoviedb.org/t/p/w1066_and_h600_face/evUpfs4dw7AuZ5k8dkePVMFSg0T.jpg", coverPosition: "center top", trailer: "https://youtu.be/Oqvly3MvlXA?si=1XWC_Bc8Dq5nCGa7" },
        { id: 4, title: "Kalki 2898 AD", rating: 9.0, year: 2024, genre: "Sci-Fi", language: "Telugu", image: "https://www.themoviedb.org/t/p/w1280/rstcAnBeCkxNQjNp3YXrF6IP1tW.jpg", coverImage: "https://media.themoviedb.org/t/p/w1066_and_h600_face/o8XSR1SONnjcsv84NRu6Mwsl5io.jpg", coverPosition: "center top", trailer: "https://youtu.be/y1-w1kUGuz8?si=kKttSqd1dLQJHALp" },
        { id: 5, title: "RRR", rating: 9.2, year: 2022, genre: "Action", language: "Telugu", image: "https://www.themoviedb.org/t/p/w1280/u0XUBNQWlOvrh0Gd97ARGpIkL0.jpg", coverImage: "https://media.themoviedb.org/t/p/w1066_and_h600_face/i0Y0wP8H6SRgjr6QmuwbtQbS24D.jpg", coverPosition: "center top", trailer: "https://youtu.be/GY4BgdUSpbE?si=Tr2VZSqaitE6jOPT" },
    ...
    kids: [
        { id: 201, title: "Hanuman", rating: 9.2, year: 2024, genre: "Animation", language: "Telugu", image: "https://www.themoviedb.org/t/p/w1280/m1zq48rWSXxplzoJR8YtbXWnnHM.jpg", trailer: "https://youtu.be/Oqvly3MvlXA?si=1XWC_Bc8Dq5nCGa7" },
        { id: 202, title: "Spider-Man: Across the Spider-Verse", rating: 8.4, year: 2023, genre: "Animation", language: "English", image: "https://www.themoviedb.org/t/p/w1280/8Vt6mWEReuy4Of61Lnj5Xj704m8.jpg", trailer: "https://youtu.be/shW9i6k8cB0" },
        { id: 203, title: "The Super Mario Bros. Movie", rating: 7.8, year: 2023, genre: "Animation", language: "English", image: "https://www.themoviedb.org/t/p/w1280/qNBAXBIQlnOThrVvA6mA2B5ggV6.jpg", trailer: "https://youtu.be/TnGl01FkMMo" },
        { id: 204, title: "Minions: The Rise of Gru", rating: 7.6, year: 2022, genre: "Animation", language: "English", image: "https://www.themoviedb.org/t/p/w1280/wKiOkZTN9lUUUNZLmtnwubZYONg.jpg", trailer: "https://youtu.be/6DxjFdpf_Ys" },
        { id: 205, title: "The Jungle Book", rating: 7.6, year: 2016, genre: "Adventure", language: "English", image: "https://www.themoviedb.org/t/p/w1280/2Epx7F9X7DrFptn4seqn4mzBVks.jpg", trailer: "https://youtu.be/HcgJRQWxKnw" },
        { id: 206, title: "Lion King", rating: 8.5, year: 2019, genre: "Adventure", language: "English", image: "https://www.themoviedb.org/t/p/w1280/dzBtMocZuJbjLOXvrl4zGYigDzh.jpg", trailer: "https://youtu.be/7TavVZMewpY" },
        { id: 207, title: "Kung Fu Panda 4", rating: 7.8, year: 2024, genre: "Animation", language: "English", image: "https://www.themoviedb.org/t/p/w1280/kDp1vUBnMpe8ak4rjgl3cLELqjU.jpg", trailer: "https://youtu.be/_inKs4eeHiI" },
        { id: 208, title: "Frozen II", rating: 7.3, year: 2019, genre: "Animation", language: "English", image: "https://www.themoviedb.org/t/p/w1280/qdfARIhgpgZOBh3vfNhWS4hmSo3.jpg", trailer: "https://youtu.be/Zi4LMpSDccc" }
    ]
};
...
function initializeApp() {
    ...
    // Expose to window for other scripts (movies.html)
...
function initializeHeroCarousel() {
    ...
    // Initial load
    currentHeroMovie = featuredMovies[0];
    updateHeroSection(currentHeroMovie);

    // Setup Play Button in Hero
    const heroPlayBtn = document.querySelector('.hero-buttons .btn-primary');
    if (heroPlayBtn) {
        heroPlayBtn.addEventListener('click', () => {
            if (currentHeroMovie) {
                openMovieModal(currentHeroMovie);
                // Also auto-play the video immediately
                playVideo('trailer');
            }
        });
    }
    ...
    heroInterval = setInterval(() => {
        ...
        currentHeroMovie = featuredMovies[currentHeroIndex];
        updateHeroSection(currentHeroMovie);
    }, 5000);
}
...
function updateHeroSection(movie) {
    ...
    const bgImage = movie.coverImage ? movie.coverImage : movie.image;
    hero.style.backgroundImage = `
        linear-gradient(to bottom, transparent 0%, var(--bg-primary) 100%),
        url('${bgImage}')
    `;
    hero.style.backgroundSize = 'cover';
    hero.style.backgroundPosition = movie.coverPosition ? movie.coverPosition : 'center';

    // Trigger Animation (Reset and Re-apply)
    if (heroContent) {
...
function createMovieCard(movie) {
    ...
    card.innerHTML = `
        <div class="movie-poster-wrapper">
            ...
            <div class="movie-overlay">
                <button class="overlay-btn play-btn" title="Play Trailer">
    ...
    // Handle button clicks separately to prevent double-firing
...
function performSearch(query) {
    ...
    if (query.length === 0) {
        ...
        if (isMoviesPage) {
            renderMovies(isMoviesPage, allMovies); // Reset movies page directly
        }
        if (isTVPage) {
            renderMovies(isTVPage, allShows); // Reset tv page directly
        }
        const isKidsPage = document.getElementById('kidsGrid');
        if (isKidsPage && movieDatabase.kids) {
            renderMovies(isKidsPage, movieDatabase.kids);
        }
        return;
    }
    ...
    if (isHomePage) {
        ...
        // If the page has its own filter logic (which includes search), delegate to it
        if (typeof window.applyMoviesFilter === 'function') {
            window.applyMoviesFilter();
            return;
        }

        // Search in all movies (Default fallback)
        const filteredMovies = allMovies.filter(movie =>
            movie.title.toLowerCase().includes(query) ||
            movie.genre.toLowerCase().includes(query) ||
            movie.language.toLowerCase().includes(query)
    ...
    const isKidsPage = document.getElementById('kidsGrid');
    if (isKidsPage) {
        if (typeof window.applyKidsFilter === 'function') {
            window.applyKidsFilter();
            return;
        }
        // Fallback
        if (movieDatabase.kids) {
            const filteredKids = movieDatabase.kids.filter(item =>
                item.title.toLowerCase().includes(query) ||
                item.genre.toLowerCase().includes(query)
            );
            renderMovies(isKidsPage, filteredKids);
        }
    }
}
...
function toggleMyList(movie) {
    let myList = JSON.parse(localStorage.getItem('vibewave-mylist')) || [];
    const index = myList.findIndex(item => item.id === movie.id);

    if (index === -1) {
        // Add to list
        myList.push(movie);
        localStorage.setItem('vibewave-mylist', JSON.stringify(myList));
        ...
        // If we are on the My List page, re-render
...
function updateAddToListButton(movie) {
    ...
    if (isInList) {
        ...
        btn.classList.add('btn-success'); // You might want to add a style for this
    } else {
...
function initializeSplashScreen() {
    ...
    // Only run on index.html (when splashScreen exists)
    if (splashScreen) {
...
function initializeProfileDropdown() {
    ...
    const profileListCount = document.getElementById('profileListCount');
    ...
    function updateProfileCount() {
        if (profileListCount) {
            let myList = JSON.parse(localStorage.getItem('vibewave-mylist')) || [];
            profileListCount.textContent = myList.length;
        }
    }
